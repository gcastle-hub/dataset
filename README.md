...
We believe the best performance (the last line) in the following table is the SOTA , welcome to contact us to update this table if you have got the better performance using another public algorithms.  
